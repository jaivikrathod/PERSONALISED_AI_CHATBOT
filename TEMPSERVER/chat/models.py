...
class ToolExecution(models.Model):
    ...
    # The internal IR that actually ran (B3: never generated by the model,
    # always logged). Null for tools that do not compile a query.
    compiled_query = models.JSONField(null=True, blank=True)
