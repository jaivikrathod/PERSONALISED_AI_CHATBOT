...
function Toast({ toast }) {
  ...
  return (
    <div
      role="status"
      className="flex w-80 items-start gap-3 rounded-xl border border-gray-200 bg-white p-4 shadow-card-hover animate-slide-in-right dark:border-gray-800 dark:bg-gray-900"
    >
